...
# Appended only when the resolved stack carries a grammar this machine reviewed.
# It is stated as a record held here rather than as something the request asked
# for, because the two must not be confusable: a grammar constrains the shape of
# the answer, while the request and passage are only ever material to describe.
